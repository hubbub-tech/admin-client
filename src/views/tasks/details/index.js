        ...
        <div className="container">
          ...
          <div className="row mb-5">
            ...
            <div className="col-sm-10">
              ...
              <p>
                Set the dropoff or pickup time through this portal. Even if the event has already had a time set, 
                you can change this time by simply scheduling a new one in the scheduling box above.
              </p>
            </div>
            <div className="col-sm-1"></div>
          </div>
